...
const PisosAlquilados = () =>
{
    ...
    return (
        <>
            ...
            {/* <Link to={`${path}/add`} onClick={() => { dispatch(previousPageCode(pageCode)); dispatch(previousPagePath(location.pathname)); }} className="btn btn-sm btn-success mb-2">Agregar Pisos Alquilados</Link>
